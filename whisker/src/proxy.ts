...
export const config = {
  matcher: [
     ...
     * - manifest.webmanifest (PWA manifest, generated by src/app/manifest.ts)
     * - images (public assets)
     */
    "/((?!_next/static|_next/image|favicon.ico|sitemap.xml|robots.txt|manifest.webmanifest|images/).*)",
  ],
};
